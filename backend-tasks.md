...
```sql
-- CRM Contacts (extends current mock data structure)
CREATE TABLE contacts (
  ...
  phone VARCHAR(50),
  country VARCHAR(100),
  status VARCHAR(50) DEFAULT 'active', -- active, prospect, inactive
...
-- Campaign Recipients (many-to-many with status tracking)
